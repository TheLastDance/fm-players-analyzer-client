export const tutorial = [
  "Start by customizing your FM game view to display all 47 attributes of each player, as the app relies on this information for skill calculation, so it is a must.",
...
export const rules = [
  ...
  "Currently, you are limited to upload files with more than 1500 players and above 2.5 MB. Keep in mind that the poor rookie developer can't afford high-performance server costs. Future popularity may lead to move expensive calculations to a client side so quotas and performance will be greatly increased.",
  ...
  "Currently, you can create up to 10 templates, with the possibility of increased quotas in the future.",
]